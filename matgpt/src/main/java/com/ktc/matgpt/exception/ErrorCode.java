...
public enum ErrorCode {
    ...
    // Common
    INVALID_SORT_TYPE(BAD_REQUEST, 400, "[MatGPT] 올바르지 않은 정렬 기준입니다."),
    ...
    REVIEW_LIST_NOT_FOUND(NOT_FOUND, 404, "[MatGPT] 요청한 리뷰 목록이 비어 있습니다."),
    REVIEW_PROCESS_ERROR(BAD_REQUEST, 400, "[MatGPT] 리뷰 등록 중 오류가 발생했습니다."),
    REVIEW_INVALID_SUMMARY_TYPE(BAD_REQUEST, 400, "[MatGPT] 올바르지 않은 요약 방식입니다."),
    REVIEW_UNAUTHORIZED_ACCESS(BAD_REQUEST, 400, "[MatGPT] 본인이 작성한 리뷰가 아닙니다."),
    REVIEW_INVALID_PEOPLE_COUNT(BAD_REQUEST, 400, "[MatGPT] 방문인원수는 0명일 수 없습니다."),
    ...
    UNAUTHORIZED_EXCEPTION(UNAUTHORIZED, 401, "[MatGPT] 유효한 인증이 필요합니다."),
