...
public class GptRequestConverter {
    ...
    public static GptRequest convertFromCountry(String country) {
        ...
        return new GptRequest(content);
    }

    public static GptRequest convertFromReviews(List<Review> reviews, String summaryType) {
